...
**Claim rows:** CLM-B-004 (ranking = BLOCKED; criteria = SAFE_WORDING)
...
- any specification quoted from a vendor is **CLM-E-001 EVIDENCE_REQUIRED** — cite the datasheet
...
- [ ] Every remaining number traces to a cited vendor datasheet (CLM-E-001, CLM-E-004, CLM-E-007) or is deleted
