...
| `PKG-Q17` | #17 | **BLOCKED** | DRAFT_PENDING_REVIEW | T2_FULL | `CLM-B-004`, `CLM-S-006` | `SRC-WEB-004` | เนื้อหาเขียนได้ทันที (revision spec พร้อม ไม่ติด source) แต่หน้าปลายทางอยู่ใน C-7 "Scanner selection / comparison" ซึ่งยังไม่มี canonical owner · ในเว็บมีหน้าที่ถือ flag RANKING อยู่สองหน้า คือ /barcode-scanner-comparison และ /knowledge/product-comparisons ทั้งคู่อยู่ใน C-7 และ RANKING เป็น flag ที่ตรงกับคำตัดสิน Queue #17 โดยตรง · การตัดสินหน้าหลักของ C-7 จะปลดแพ็กเกจนี้ทันที |
