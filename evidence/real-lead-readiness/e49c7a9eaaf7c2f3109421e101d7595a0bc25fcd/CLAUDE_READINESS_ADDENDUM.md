...
Exact source: e49c7a9eaaf7c2f3109421e101d7595a0bc25fcd
...
This exact source also repairs a CI-reproduced lost mock contact click during saved-image restoration; a deterministic held-restore call-event regression is included. cd259 local79 PASS did not prove this race absent; its CI was REVISE.



The final source additionally guards initial restoration callbacks from overwriting confirmed withdrawal with old-session event errors. The deterministic regression was first observed failing against e4d6435; no content resurrection occurred.
...
SHA-256: 33e62adb53e7f7b7a1c2021a1fb862d50833fc3570e7021df52486675053405d
```
"use client";
...
SHA-256: b04d94306caf7feb624dfaaa67c3e1dc29b3c8b43a9ceb401a6834ef40ee2dab
```
import { syntheticPng } from "../helpers/synthetic-image.mjs";
