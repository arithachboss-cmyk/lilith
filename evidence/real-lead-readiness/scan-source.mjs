...
// node evidence/real-lead-readiness/scan-source.mjs
...
const sourceSha = '8bd0e3d7a223db392e55c5f2533451bff716a464';
...
const result = {
  ...
  command: 'node evidence/real-lead-readiness/scan-source.mjs',
  scanner_version: 1,
