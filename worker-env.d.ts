/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-env.d.ts --config dist/server/wrangler.json` (hash: bd8a696e9e1e5b24667a94e961772bd2)
// Runtime types generated with workerd@1.20260515.1 2026-05-15 nodejs_compat
interface __BaseEnv_Env {
	AGENT_PHOTOS: R2Bucket;
	DB: D1Database;
}
